...
?>
<div class="container">
    <h1 class="text-center"> <?= $p["title"]?></h1></div>
...
<?php if(!isset($_SESSION["connected"])) : ?> 
  ...
  <ul class="nav">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="pages/properties/contact.php?id=<?=$p["id"]?>"> <h2> Nous contacter pour ce bien</h2></a>
  </li>
